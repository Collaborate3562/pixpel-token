...
/// The contract state,
#[contract_state(contract = "pixpel-token")]
#[derive(Serialize, SchemaType)]
struct State {
...
/// is not the receiver.
#[receive(contract = "pixpel-token", name = "wrap", parameter = "WrapParams", enable_logger, payable)]
...
#[receive(contract = "pixpel-token", name = "unwrap", parameter = "UnwrapParams", enable_logger)]
...
#[receive(contract = "pixpel-token", name = "balanceOf", parameter = "ContractBalanceOfQueryParams")]
...
/// - It fails to parse the parameter.
/// - Message sent back with the result rejects.
#[receive(contract = "pixpel-token", name = "operatorOf", parameter = "OperatorOfQueryParams")]
